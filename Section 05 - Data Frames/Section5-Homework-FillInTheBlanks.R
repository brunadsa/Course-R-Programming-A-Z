...
getwd()
setwd("_")
getwd("D:\\brunn\\Documents\\Bruna\\03 Formação Acadêmica\\Cursos\\Curso Programação em R\\Section 05 - Data Frames") 
...
tail(data)      #check the structure of the data frame
